...
const DetailsPanel = ({fetchSalaryCallFn,estimateSalaryFn,saveSalaryFn,finalizeSalaryFn}) => {
    ...
    return (
        <Container>
            ...
            <Row>
                <Col className="bg-light border">
                    <InputPanel onCalculate={estimateSalaryFn} onSave={saveSalaryFn} onFinalize={finalizeSalaryFn} />
                </Col>
            </Row>
            <Row>
                <Col className="bg-light border">
